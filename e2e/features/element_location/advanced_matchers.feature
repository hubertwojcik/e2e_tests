Feature: Advanced matchers
    ...
    Elements can be matches dynamically and navigation elements can be located

    @advancedmatchers @dynamic
    Scenario: Home sections can be matched dinamically
    ...
    Given I tap on the '<section_2>' navigation tab
